...
from rime_core.export import ExporterRegistry
...
class WorkingContext:
    ...
    def _read_first_timestamp_as_epoch_s(signal: Signal) -> float:
        ...
        if signal.time_unit == "milliseconds":
            return first_value / 1_000.0
        if signal.time_unit == "microseconds":
            return first_value / 1_000_000.0
        if signal.time_unit == "nanoseconds":
            return first_value / 1_000_000_000.0
        return first_value
