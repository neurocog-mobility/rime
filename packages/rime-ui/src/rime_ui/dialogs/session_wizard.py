...
from rime_core.sessions import save_session
...
_BUILTIN_SCHEMAS: list[tuple[str, str, Path]] = [
    ...
    ("gpfog", "GP-FOG", DEFAULT_SCHEMA_PATH),
]
...
class SessionWizard(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        fog_index = next((idx for idx, (key, _, _) in enumerate(_BUILTIN_SCHEMAS) if key == "gpfog"), 0)
