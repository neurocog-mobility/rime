...
from rime_core import AnnotationStore
...
from rime_core.export import _filtered_annotations
...
class ExportDialog(QDialog):
    ...
    def _setup_ui(self) -> None:
        ...
        output_row.addWidget(QLabel("Export folder for this session:", self))
    ...
    def _update_summary(self) -> None:
        ...
        elif not self._context.session.videos:
            self.video_status_label.setText("Video clip export unavailable: no videos in this session.")
        else:
            self.video_status_label.setText("")
        video_controls_enabled = self.video_checkbox.isChecked() and self.video_checkbox.isEnabled()
