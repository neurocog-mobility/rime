...
class AnnotationToolbar(QToolBar):
    ...
    def set_selection_state(
        ...
        self.accept_ghost_action.setEnabled(has_ghost and editable)
        self.reject_ghost_action.setEnabled(has_ghost and editable)
        self.delete_action.setEnabled((has_annotation or has_snap) and editable)
        self.edit_action.setEnabled(has_annotation and editable)
        self.cut_action.setEnabled(has_annotation and editable)
